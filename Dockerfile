...
RUN mkdir ./config \
    [[ -e ./config/query_ip_allowlist.txt ]] && cp -fs ./config/query_ip_allowlist.txt ./query_ip_allowlist.txt \
    [[ -e ./config/query_ip_denylist.txt ]] && cp -fs ./config/query_ip_denylist.txt ./query_ip_denylist.txt \
    mkdir ./data \
